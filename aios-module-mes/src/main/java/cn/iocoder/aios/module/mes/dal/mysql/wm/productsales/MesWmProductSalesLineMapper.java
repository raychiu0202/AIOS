package cn.iocoder.aios.module.mes.dal.mysql.wm.productsales;
...
public interface MesWmProductSalesLineMapper extends BaseMapperX<MesWmProductSalesLineDO> {
    ...
    default cn.iocoder.aios.framework.common.pojo.PageResult<MesWmProductSalesLineDO> selectPage(
            cn.iocoder.aios.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO reqVO) {
        return selectPage(reqVO, new cn.iocoder.aios.framework.mybatis.core.query.LambdaQueryWrapperX<MesWmProductSalesLineDO>()
