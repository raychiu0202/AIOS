package cn.iocoder.aios.module.mes.service.wm.warehouse;
...
import cn.iocoder.aios.module.mes.dal.mysql.wm.warehouse.MesWmWarehouseLocationMapper;
    ...
    public MesWmWarehouseLocationDO getWarehouseLocationByCode(String code) {
        ...
        if (MesWmWarehouseLocationDO.WIP_VIRTUAL_LOCATION.equals(code)) {
            ...
            MesWmWarehouseLocationDO newLocation = MesWmWarehouseLocationDO.builder()
                    ...
                    .areaStatus(cn.iocoder.aios.framework.common.enums.CommonStatusEnum.ENABLE.getStatus())
