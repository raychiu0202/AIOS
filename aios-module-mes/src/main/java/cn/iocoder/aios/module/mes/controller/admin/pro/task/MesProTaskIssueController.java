...
import cn.iocoder.aios.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import cn.iocoder.aios.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import cn.iocoder.aios.module.mes.service.pro.task.MesProTaskIssueService;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return cn.iocoder.aios.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
