...
import cn.iocoder.aios.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import cn.iocoder.aios.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import cn.iocoder.aios.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import cn.iocoder.aios.module.mes.enums.qc.MesQcCheckResultEnum;
...
import static cn.iocoder.aios.module.mes.enums.ErrorCodeConstants.WM_PRODUCT_SALES_LINE_NOT_EXISTS;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public cn.iocoder.aios.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return cn.iocoder.aios.framework.common.pojo.PageResult.empty();
            }
