package cn.iocoder.aios.module.ai.framework.ai.core.model;
...
import cn.iocoder.aios.framework.common.util.spring.SpringUtils;
import cn.iocoder.aios.module.ai.enums.model.AiPlatformEnum;
import cn.iocoder.aios.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.iocoder.aios.module.ai.framework.ai.config.AiosAiProperties;
...
import cn.iocoder.aios.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.iocoder.aios.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            AiosAiProperties.Midjourney properties = SpringUtil.getBean(AiosAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(AiosAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        AiosAiProperties.DouBao properties = new AiosAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(AiosAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        AiosAiProperties.HunYuan properties = new AiosAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(AiosAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        AiosAiProperties.SiliconFlow properties = new AiosAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(AiosAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        AiosAiProperties.XingHuo properties = new AiosAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(AiosAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        AiosAiProperties.BaiChuan properties = new AiosAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(AiosAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        AiosAiProperties.Gemini properties = SpringUtil.getBean(AiosAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        AiosAiProperties.Grok properties = new AiosAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
