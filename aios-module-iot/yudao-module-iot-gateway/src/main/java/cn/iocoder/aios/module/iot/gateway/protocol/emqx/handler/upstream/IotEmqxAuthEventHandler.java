package cn.iocoder.aios.module.iot.gateway.protocol.emqx.handler.upstream;
...
import cn.iocoder.aios.module.iot.gateway.protocol.emqx.IotEmqxProtocol;
    ...
    private void sendRegisterResultMessage(String username, IotDeviceRegisterRespDTO result) {
        ...
        try {
            ...
            byte[] encodedData = deviceMessageService.serializeDeviceMessage(responseMessage,
                    cn.iocoder.aios.module.iot.core.enums.IotSerializeTypeEnum.JSON);
            // 1.3 构建响应主题
