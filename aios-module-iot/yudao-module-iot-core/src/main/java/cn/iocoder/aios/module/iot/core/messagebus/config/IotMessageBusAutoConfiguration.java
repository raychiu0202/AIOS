package cn.iocoder.aios.module.iot.core.messagebus.config;

import cn.iocoder.aios.framework.mq.redis.core.RedisMQTemplate;
import cn.iocoder.aios.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.iocoder.aios.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.iocoder.aios.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.iocoder.aios.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.iocoder.aios.module.iot.core.messagebus.core.IotMessageBus;
import cn.iocoder.aios.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.iocoder.aios.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.iocoder.aios.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "aios.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "aios.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 AiosRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.iocoder.aios.framework.mq.redis.config.AiosRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "aios.iot.message-bus", name = "type", havingValue = "redis")
