package cn.iocoder.aios.module.iot.job.device;
...
import cn.iocoder.aios.module.iot.framework.iot.config.AiosIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private AiosIotProperties iotProperties;
