package cn.iocoder.aios.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.iocoder.aios.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
