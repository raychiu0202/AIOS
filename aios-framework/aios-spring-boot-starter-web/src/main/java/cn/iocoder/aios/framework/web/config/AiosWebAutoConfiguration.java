package cn.iocoder.aios.framework.web.config;
...
import cn.iocoder.aios.framework.web.core.filter.CacheRequestBodyFilter;
import cn.iocoder.aios.framework.web.core.filter.DemoFilter;
import cn.iocoder.aios.framework.web.core.handler.GlobalExceptionHandler;
import cn.iocoder.aios.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class AiosWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "aios.demo", havingValue = "true")
