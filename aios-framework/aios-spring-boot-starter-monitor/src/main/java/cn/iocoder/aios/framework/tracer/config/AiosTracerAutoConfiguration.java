package cn.iocoder.aios.framework.tracer.config;

import cn.iocoder.aios.framework.common.enums.WebFilterOrderEnum;
import cn.iocoder.aios.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "aios.tracer", value = "enable", matchIfMissing = true)
public class AiosTracerAutoConfiguration {
