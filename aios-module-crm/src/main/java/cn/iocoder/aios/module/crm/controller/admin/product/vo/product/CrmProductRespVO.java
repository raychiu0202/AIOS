package cn.iocoder.aios.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "cn.iocoder.aios.module.system.dal.dataobject.user.AdminUserDO",
