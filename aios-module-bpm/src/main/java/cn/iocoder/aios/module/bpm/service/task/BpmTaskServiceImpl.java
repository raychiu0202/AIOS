...
import cn.iocoder.aios.framework.common.util.number.NumberUtils;
...
import cn.iocoder.aios.framework.web.core.util.WebFrameworkUtils;
import cn.iocoder.aios.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.iocoder.aios.module.bpm.controller.admin.task.vo.task.*;
import cn.iocoder.aios.module.bpm.convert.task.BpmTaskConvert;
import cn.iocoder.aios.module.bpm.dal.dataobject.definition.BpmFormDO;
import cn.iocoder.aios.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.iocoder.aios.module.bpm.enums.definition.*;
import cn.iocoder.aios.module.bpm.enums.task.BpmCommentTypeEnum;
import cn.iocoder.aios.module.bpm.enums.task.BpmReasonEnum;
import cn.iocoder.aios.module.bpm.enums.task.BpmTaskSignTypeEnum;
...
import cn.iocoder.aios.module.bpm.service.definition.BpmFormService;
import cn.iocoder.aios.module.bpm.service.definition.BpmModelService;
...
import cn.iocoder.aios.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static cn.iocoder.aios.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
//        }
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 aios-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
