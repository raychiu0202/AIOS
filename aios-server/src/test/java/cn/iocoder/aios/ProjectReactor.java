...
public class ProjectReactor {
    ...
    private static final String ARTIFACT_ID = "aios";
    private static final String PACKAGE_NAME = "cn.iocoder.aios";
    private static final String TITLE = "小凌管理系统";
